  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbJsonLd([{ name: 'Sobre', href: '/sobre' }])) }}
      />
      <script
        type="application/ld+json"
          ...
          <div>
            ...
            <div className="card p-6">
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 mt-3 text-sm font-semibold text-teal-700 hover:text-teal-800 transition-colors"
              >
                Currículo Lattes
