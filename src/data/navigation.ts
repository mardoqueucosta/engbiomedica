...
export const mainNavigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: 'Visão Geral', href: '/areas-de-atuacao' },
      ...
      { label: 'Neuroengenharia e BCI', href: '/artigos/neuroengenharia-bci' },
      { label: 'Robótica Cirúrgica', href: '/artigos/cirurgia-robotica-brasil' },
      { label: 'Bioimpressão 3D', href: '/artigos/engenharia-tecidos-bioimpressao-3d' },
      { label: 'Engenharia Genômica e CRISPR', href: '/artigos/engenharia-genomica-crispr' },
      { label: 'Nanotecnologia Biomédica', href: '/artigos/nanotecnologia-biomedica' },
    ],
  },
  {
    label: 'Mercado',
