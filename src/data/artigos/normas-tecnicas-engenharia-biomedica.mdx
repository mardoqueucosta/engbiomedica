...
resumo: 'Guia completo das normas técnicas essenciais para engenheiros biomédicos: IEC 60601 (segurança de equipamentos eletromédicos), ISO 13485 (gestão da qualidade), ISO 14971 (gerenciamento de risco), IEC 62366 (usabilidade), IEC 62304 (software médico) e ISO 10993 (biocompatibilidade).'
