...
<p>Esses dados são expressos em <strong>suportes legíveis por máquina</strong> aplicados na embalagem: código de barras linear GS1-128, símbolo bidimensional DataMatrix (ISO/IEC 16022) e, onde aplicável, etiquetas RFID. Para dispositivos implantáveis, a marcação direta no item — quando tecnicamente viável — também é prevista, seguindo padrões da série <strong>ISO 15223</strong>.</p>
...
<p>O mercado brasileiro de dispositivos médicos movimenta cerca de <strong>R$ 60 bilhões por ano</strong> e conta com mais de <strong>50.000 produtos registrados</strong> na ANVISA, segundo dados da ABIMO (Associação Brasileira da Indústria de Artigos e Equipamentos Médicos, Odontológicos, Hospitalares e de Laboratórios). Esse volume expressivo, aliado à extensão territorial e à complexidade logística do país, cria desafios estruturais para a vigilância sanitária.</p>
