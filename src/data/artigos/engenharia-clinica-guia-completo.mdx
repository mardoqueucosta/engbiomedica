...
imagens:
  - src: '/artigos/engenharia-clinica-guia-completo/image-1.webp'
    alt: 'Painel de KPIs de engenharia clínica mostrando MTBF, MTTR e disponibilidade de equipamentos hospitalares críticos em dashboard hospitalar'
    caption: 'Os indicadores MTBF, MTTR e disponibilidade formam a base do monitoramento de desempenho em qualquer Serviço de Engenharia Clínica moderno.'
  - src: '/artigos/engenharia-clinica-guia-completo/image-2.webp'
    alt: 'Diagrama de classificação de criticidade de equipamentos hospitalares em Classes I, II e III conforme NBR 15943 para programa de gerenciamento em engenharia clínica'
    caption: 'A classificação de criticidade define a prioridade de manutenção e os recursos alocados para cada equipamento do parque tecnológico hospitalar.'
  - src: '/artigos/engenharia-clinica-guia-completo/image-3.webp'
    alt: 'Engenheiro clínico inspecionando equipamento médico de alta complexidade em hospital com tablet CMMS e documentação técnica de ordem de serviço'
    caption: 'A rotina do engenheiro clínico combina inspeção técnica presencial, gestão digital de ordens de serviço e interface direta com as equipes clínicas do hospital.'
---
