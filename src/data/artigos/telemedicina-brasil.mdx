...
imagens:
  - src: '/artigos/telemedicina-brasil/image-1.webp'
    alt: 'Linha do tempo da regulamentação da telemedicina no Brasil de 2002 a 2022 com marcos regulatórios do CFM e legislação federal'
    caption: 'Evolução regulatória da telemedicina no Brasil: de resolução restritiva em 2002 à lei permanente em 2022.'
  - src: '/artigos/telemedicina-brasil/image-2.webp'
    alt: 'Diagrama das sete modalidades de telemedicina brasileira conforme CFM 2314/2022 com definições e exemplos de aplicação clínica'
    caption: 'As 7 modalidades oficiais de telemedicina no Brasil, regulamentadas pela Resolução CFM 2.314/2022.'
  - src: '/artigos/telemedicina-brasil/image-3.webp'
    alt: 'Médico realizando teleconsulta em consultório moderno com plataforma digital de telemedicina em monitor de alta resolução'
    caption: 'Plataformas digitais de telemedicina transformam o fluxo de trabalho clínico em consultórios e hospitais brasileiros.'
---
