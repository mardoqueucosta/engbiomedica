...
imagens:
  - src: '/artigos/informatica-saude-his-prontuario/image-1.webp'
    alt: 'Diagrama de arquitetura de Sistema de Informação Hospitalar (HIS) com módulos clínicos, administrativos e interoperabilidade HL7 FHIR'
    caption: 'Arquitetura típica de HIS moderno: módulos administrativos, clínicos e departamentais integrados por barramento HL7/FHIR.'
  - src: '/artigos/informatica-saude-his-prontuario/image-2.webp'
    alt: 'Comparativo técnico dos padrões de interoperabilidade em saúde HL7 v2, CDA e FHIR R4 com exemplos de estrutura de dados'
    caption: 'Evolução dos padrões HL7: de mensagens pipe-delimited (v2) ao FHIR R4 com APIs RESTful e JSON.'
  - src: '/artigos/informatica-saude-his-prontuario/image-3.webp'
    alt: 'Mapa de cobertura da Rede Nacional de Dados em Saúde RNDS no Brasil com 21 estados integrados e 3.805 municípios conectados em 2025'
    caption: 'Cobertura da RNDS em 2025: 21 estados + DF integrados, 3.805 municípios e 2,8 bilhões de registros clínicos.'
---
