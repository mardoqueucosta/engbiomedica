---
titulo: >-
  Software como Dispositivo Médico (SaMD): Guia Completo de Regulação no Brasil
  [2026]
resumo: >-
  Entenda o que é SaMD, como funciona a regulação ANVISA (RDC 657/2022), a
  matriz de risco IMDRF, comparação com FDA e EU MDR, e o caminho para aprovação
  de softwares médicos no Brasil.
...
leitura: 14 min
imagens:
  - src: /artigos/samd-software-dispositivo-medico/diagrama-comparativo-entre-samd-simd-e-software-acessor-1.webp
    alt: >-
      Diagrama comparativo entre SaMD, SiMD e software acessório de dispositivo
      médico com exemplos e fronteiras regulatórias definidas pela ANVISA e
      IMDRF
    caption: >-
      Distinção entre as três categorias de software em saúde: SaMD opera de
      forma independente, SiMD integra hardware médico, e o software acessório
      auxilia sem função médica autônoma.
  - src: /artigos/samd-software-dispositivo-medico/matriz-de-risco-imdrf-3x3-mostrando-categorias-i-a-iv-p-2.webp
    alt: >-
      Matriz de risco IMDRF 3x3 mostrando categorias I a IV para classificação
      de SaMD com base em natureza da informação gerada e gravidade da condição
      clínica
    caption: >-
      A matriz IMDRF cruza a natureza da informação produzida pelo SaMD com a
      gravidade da condição clínica, resultando em quatro categorias de risco
      que determinam o rigor regulatório exigido.
  - src: /artigos/samd-software-dispositivo-medico/comparacao-entre-os-sistemas-regulatorios-anvisa-fda-e--3.webp
    alt: >-
      Comparação entre os sistemas regulatórios ANVISA, FDA e EU MDR para
      aprovação de SaMD mostrando volume de aprovações e principais marcos
      regulatórios de cada jurisdição
    caption: >-
      O Brasil possui cerca de 100 SaMDs aprovados frente a mais de 1.250
      autorizados pelo FDA. A dupla conformidade MDR e EU AI Act exigida na
      Europa a partir de 2027 elevará ainda mais o rigor regulatório global.
tldr: >-
  Software como Dispositivo Médico (SaMD) é hoje um dos segmentos de maior
  crescimento em toda a cadeia de tecnologia em saúde.
---
...
<figure>
<img src="/artigos/samd-software-dispositivo-medico/diagrama-comparativo-entre-samd-simd-e-software-acessor-1.webp" alt="Diagrama comparativo entre SaMD, SiMD e software acessório de dispositivo médico com exemplos e fronteiras regulatórias definidas pela ANVISA e IMDRF" width="1024" height="571" loading="eager" fetchpriority="high" decoding="async" aria-details="desc-samd-software-dispositivo-medico-1">
<figcaption>Distinção entre as três categorias de software em saúde: SaMD opera de forma independente, SiMD integra hardware médico, e o software acessório auxilia sem função médica autônoma.
<details id="desc-samd-software-dispositivo-medico-1">
<summary>Descrição completa da imagem</summary>
<p>Diagrama comparativo entre SaMD, SiMD e software acessório de dispositivo médico com exemplos e fronteiras regulatórias definidas pela ANVISA e IMDRF.</p>
</details>
</figcaption>
</figure>
...
<figure>
<img src="/artigos/samd-software-dispositivo-medico/matriz-de-risco-imdrf-3x3-mostrando-categorias-i-a-iv-p-2.webp" alt="Matriz de risco IMDRF 3x3 mostrando categorias I a IV para classificação de SaMD com base em natureza da informação gerada e gravidade da condição clínica" width="1024" height="571" loading="lazy" decoding="async" aria-details="desc-samd-software-dispositivo-medico-2">
<figcaption>A matriz IMDRF cruza a natureza da informação produzida pelo SaMD com a gravidade da condição clínica, resultando em quatro categorias de risco que determinam o rigor regulatório exigido.
<details id="desc-samd-software-dispositivo-medico-2">
<summary>Descrição completa da imagem</summary>
<p>Matriz de risco IMDRF 3x3 mostrando categorias I a IV para classificação de SaMD com base em natureza da informação gerada e gravidade da condição clínica.</p>
</details>
</figcaption>
</figure>
...
<blockquote><p>A RDC 657/2022 foi resultado de processo que incluiu Consulta Pública n. 1.035/2021, com mais de 440 contribuições da sociedade, e Analise de Impacto Regulatorio que reconheceu a impossibilidade de aplicar as regulacoes vigentes de hardware a software.</p><cite>— ANVISA, Consulta Publica 1.035/2021 e AIR da RDC 657/2022</cite></blockquote>

<h2>Cenário Atual: Brasil vs. FDA vs. União Europeia</h2>
<figure>
<img src="/artigos/samd-software-dispositivo-medico/comparacao-entre-os-sistemas-regulatorios-anvisa-fda-e--3.webp" alt="Comparação entre os sistemas regulatórios ANVISA, FDA e EU MDR para aprovação de SaMD mostrando volume de aprovações e principais marcos regulatórios de cada jurisdição" width="1024" height="571" loading="lazy" decoding="async" aria-details="desc-samd-software-dispositivo-medico-3">
<figcaption>O Brasil possui cerca de 100 SaMDs aprovados frente a mais de 1.250 autorizados pelo FDA. A dupla conformidade MDR e EU AI Act exigida na Europa a partir de 2027 elevará ainda mais o rigor regulatório global.
<details id="desc-samd-software-dispositivo-medico-3">
<summary>Descrição completa da imagem</summary>
<p>Comparação entre os sistemas regulatórios ANVISA, FDA e EU MDR para aprovação de SaMD mostrando volume de aprovações e principais marcos regulatórios de cada jurisdição.</p>
</details>
</figcaption>
</figure>
...
<blockquote><p>A FDA lidera mundialmente em regulacao de SaMD com IA, tendo autorizado mais de 1.250 dispositivos medicos com IA/ML ate meados de 2025, dos quais 295 somente em 2025. A maioria absoluta (97%) e aprovada via 510(k).</p><cite>— FDA Digital Health Center of Excellence, 2025</cite></blockquote>
...
<p class="mb-6">Para desenvolvedores com ambições de mercado global, a estratégia mais eficiente costuma ser iniciar pela aprovação FDA ou CE Mark e depois adaptar o dossiê técnico para a ANVISA, aproveitando o reconhecimento mútuo parcial que o Brasil vem desenvolvendo com essas jurisdições. Para entender os requisitos mais recentes do FDA, incluindo o novo QMSR e as exigências de segurança digital, veja nosso artigo sobre <a href="/artigos/qmsr-e-ciberseguranca-da-fda-requisitos-essenciais-para-disp">QMSR e cibersegurança da FDA para dispositivos médicos</a>.</p>
...
<blockquote><p>O ecossistema brasileiro conta com mais de 1.200 healthtechs ativas, crescimento de 35% desde 2020, das quais 130 aplicam inteligencia artificial. O mercado de saude digital pode alcancar USD 21,9 bilhoes ate 2030.</p><cite>— Distrito Healthtech Report 2024; Grand View Research, 2024</cite></blockquote>
