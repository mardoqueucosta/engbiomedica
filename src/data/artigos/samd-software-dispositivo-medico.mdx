...
imagens:
  - src: '/artigos/samd-software-dispositivo-medico/image-1.webp'
    alt: 'Diagrama comparativo entre SaMD, SiMD e software acessório de dispositivo médico com exemplos e fronteiras regulatórias definidas pela ANVISA e IMDRF'
    caption: 'Distinção entre as três categorias de software em saúde: SaMD opera de forma independente, SiMD integra hardware médico, e o software acessório auxilia sem função médica autônoma.'
  - src: '/artigos/samd-software-dispositivo-medico/image-2.webp'
    alt: 'Matriz de risco IMDRF 3x3 mostrando categorias I a IV para classificação de SaMD com base em natureza da informação gerada e gravidade da condição clínica'
    caption: 'A matriz IMDRF cruza a natureza da informação produzida pelo SaMD com a gravidade da condição clínica, resultando em quatro categorias de risco que determinam o rigor regulatório exigido.'
  - src: '/artigos/samd-software-dispositivo-medico/image-3.webp'
    alt: 'Comparação entre os sistemas regulatórios ANVISA, FDA e EU MDR para aprovação de SaMD mostrando volume de aprovações e principais marcos regulatórios de cada jurisdição'
    caption: 'O Brasil possui cerca de 100 SaMDs aprovados frente a mais de 1.250 autorizados pelo FDA. A dupla conformidade MDR e EU AI Act exigida na Europa a partir de 2027 elevará ainda mais o rigor regulatório global.'
---
