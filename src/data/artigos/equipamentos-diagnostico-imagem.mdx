...
resumo: >-
  Guia técnico completo sobre as cinco principais modalidades de diagnóstico por
  imagem, raio-X, tomografia computadorizada, ressonância magnética, ultrassom e
  PET-CT, com princípios físicos, especificações técnicas, regulamentação
  CNEN/ANVISA, cenário brasileiro e integração com inteligência artificial.
categoria: Profissão
...
leitura: 15 min
imagens:
  - src: /artigos/equipamentos-diagnostico-imagem/sala-de-diagnostico-por-imagem-hospitalar-com-tomografo-1.webp
    alt: >-
      Sala de diagnóstico por imagem hospitalar com tomógrafo multislice,
      ressonância magnética 3T e sistema de ultrassom de última geração
      dispostos em ambiente clínico moderno
    caption: >-
      O Brasil conta com mais de 293.000 equipamentos de diagnóstico por imagem
      cadastrados, atendendo mais de 500 milhões de procedimentos ao ano nas
      redes pública e privada.
  - src: /artigos/equipamentos-diagnostico-imagem/diagrama-tecnico-explodido-de-tomografo-computadorizado-2.webp
    alt: >-
      Diagrama técnico explodido de tomógrafo computadorizado de quarta geração
      com tubo de raio-X, anel de detectores, colimadores e fluxo de
      reconstrução de imagem por retroprojeção filtrada
    caption: >-
      Tomógrafos de última geração com detectores photon-counting (PCD-CT)
      eliminam o cintilador intermediário, reduzindo dose em até 50% e
      aumentando a resolução espectral para diagnóstico diferenciado de tecidos.
  - src: /artigos/equipamentos-diagnostico-imagem/diagrama-tecnico-de-corte-longitudinal-de-sistema-de-re-3.webp
    alt: >-
      Diagrama técnico de corte longitudinal de sistema de ressonância magnética
      3 Tesla mostrando magneto supercondutor com criostato de hélio, bobinas de
      gradiente triaxiais e bobinas de radiofrequência
    caption: >-
      Um sistema de RM 3T requer blindagem magnética ativa e passiva para conter
      o campo de 5 gauss (linha de exclusão), consumindo entre 45 e 60 kVA em
      operação contínua e gerando calor residual gerenciado por chillers de
      precisão.
tldr: >-
  O diagnóstico por imagem é o eixo tecnológico que sustenta o sistema de saúde
  moderno: em 2025, o mercado global de equipamentos de imagem médica foi
  avaliado em US$ 44–48 bilhões com projeção de atingir US$ 70 bilhões até 2032,
  e o Brasil, com mais de 293.
---
...
<blockquote><p>O total de dispositivos de IA/ML aprovados pela FDA ultrapassa 1.300 em dezembro de 2025, sendo 80% voltados para radiologia. A GE HealthCare lidera com 115 algoritmos aprovados, seguida pela Siemens (86) e Philips (48).</p><cite>— FDA, Artificial Intelligence and Machine Learning (AI/ML)-Enabled Medical Devices, 2025</cite></blockquote>
...
<figure>
<img src="/artigos/equipamentos-diagnostico-imagem/sala-de-diagnostico-por-imagem-hospitalar-com-tomografo-1.webp" alt="Sala de diagnóstico por imagem hospitalar com tomógrafo multislice, ressonância magnética 3T e sistema de ultrassom de última geração dispostos em ambiente clínico moderno" loading="eager" fetchpriority="high" />
...
<blockquote><p>O Siemens NAEOTOM Alpha, primeiro tomógrafo photon-counting aprovado pela FDA em 2021, já realizou mais de 1 milhão de exames globalmente. Em 2024, a Siemens investiu 80 milhões de euros na expansão da produção de detectores em Forchheim.</p><cite>— Siemens Healthineers, Relatório Anual, 2024</cite></blockquote>
...
<figure>
<img src="/artigos/equipamentos-diagnostico-imagem/diagrama-tecnico-explodido-de-tomografo-computadorizado-2.webp" alt="Diagrama técnico explodido de tomógrafo computadorizado de quarta geração com tubo de raio-X, anel de detectores, colimadores e fluxo de reconstrução de imagem por retroprojeção filtrada" loading="lazy" / aria-details="desc-equipamentos-diagnostico-imagem-1">
<figcaption>Tomógrafos de última geração com detectores photon-counting (PCD-CT) eliminam o cintilador intermediário, reduzindo dose em até 50% e aumentando a resolução espectral para diagnóstico diferenciado de tecidos.
<details id="desc-equipamentos-diagnostico-imagem-1">
<summary>Descrição completa da imagem</summary>
<p>Diagrama técnico explodido de tomógrafo computadorizado de quarta geração com tubo de raio-X, anel de detectores, colimadores e fluxo de reconstrução de imagem por retroprojeção filtrada.</p>
</details>
</figcaption>
</figure>
...
<p>Para o contexto regulatório desses equipamentos, incluindo o processo de registro junto à ANVISA, recomendamos nosso guia sobre <a href="/artigos/como-registrar-dispositivo-medico-anvisa">como registrar dispositivos médicos na ANVISA</a>. Um exemplo recente de avanço na área é a <a href="/artigos/ressonancia-magnetica-ge-healthcare-signa-fda-2026">aprovação FDA do sistema SIGNA da GE Healthcare em 2026</a>.</p>
...
<figure>
<img src="/artigos/equipamentos-diagnostico-imagem/diagrama-tecnico-de-corte-longitudinal-de-sistema-de-re-3.webp" alt="Diagrama técnico de corte longitudinal de sistema de ressonância magnética 3 Tesla mostrando magneto supercondutor com criostato de hélio, bobinas de gradiente triaxiais e bobinas de radiofrequência" loading="lazy" / aria-details="desc-equipamentos-diagnostico-imagem-2">
<figcaption>Um sistema de RM 3T requer blindagem magnética ativa e passiva para conter o campo de 5 gauss (linha de exclusão), consumindo entre 45 e 60 kVA em operação contínua e gerando calor residual gerenciado por chillers de precisão.
<details id="desc-equipamentos-diagnostico-imagem-2">
<summary>Descrição completa da imagem</summary>
<p>Diagrama técnico de corte longitudinal de sistema de ressonância magnética 3 Tesla mostrando magneto supercondutor com criostato de hélio, bobinas de gradiente triaxiais e bobinas de radiofrequência.</p>
</details>
</figcaption>
</figure>
...
<blockquote><p>O Brasil possui apenas 105 a 135 PET-CTs instalados, com densidade de aproximadamente 0,5 por milhão de habitantes, metade da recomendação mínima da OMS de 1 por milhão. Cinco estados brasileiros não possuem nenhum equipamento PET-CT.</p><cite>— SBMN / CNES-DATASUS, 2024</cite></blockquote>
