---
titulo: >-
  Medtronic Obtém Autorização da FDA para Sistema Robótico Espinhal Stealth AXiS
  [2026]
resumo: >-
  A Medtronic recebeu clearance da FDA para o Stealth AXiS, sistema robótico
  para coluna baseado na plataforma Mazor, reforçando sua posição no mercado
  global de US$ 15 bilhões em tecnologias cranianas e espinhais.
categoria: Mercado
...
leitura: 8 min
tldr: >-
  A Medtronic recebeu autorização da FDA (Food and Drug Administration) em
  fevereiro de 2026 para o Stealth AXiS seu mais novo sistema robótico voltado à
