...
imagens:
  - src: '/artigos/engenharia-tecidos-bioimpressao-3d/image-1.webp'
    alt: 'Comparativo das quatro modalidades de bioimpressão 3D, extrusão, inkjet, laser LIFT e fotopolimerização SLA, resolução e viabilidade celular'
    caption: 'As quatro modalidades de bioimpressão 3D diferem em resolução, viabilidade celular e compatibilidade com bioinks. A extrusão domina os laboratórios brasileiros pelo custo-benefício; a fotopolimerização MSLA ganha espaço com o TissueRay™ da TissueLabs.'
  - src: '/artigos/engenharia-tecidos-bioimpressao-3d/image-2.webp'
    alt: 'Pesquisador operando bioimpressor 3D em laboratório brasileiro de engenharia de tecidos, depositando bioink com células vivas camada por camada'
    caption: 'Laboratórios como CTI Renato Archer, INCT-Biofabris/UNICAMP e CNPEM/LNBio operam bioimpressores de última geração para pesquisa em engenharia de tecidos. O Brasil lidera 59% das publicações latino-americanas no campo.'
  - src: '/artigos/engenharia-tecidos-bioimpressao-3d/image-3.webp'
    alt: 'Espectro de maturidade clínica das aplicações de engenharia de tecidos no Brasil, de curativos biológicos a órgãos bioimpressos, com status regulatório ANVISA'
    caption: 'O espectro de maturidade clínica na engenharia de tecidos brasileira vai do Mesencure® (fase ANVISA 1/2) ao coração bioartificial da TissueLabs/InCor (horizonte 10–15 anos). Scaffolds ósseos do ProMed já beneficiaram 6.400+ pacientes no SUS.'
---
