...
<figure>
<img src="/artigos/guia-compra-equipamentos-hospitalares/comissao-de-licitacao-hospitalar-analisando-documentos--1.webp" alt="Comissão de licitação hospitalar analisando documentos técnicos de equipamentos médicos com Portal Nacional de Contratações Públicas aberto em notebook" loading="eager" />
