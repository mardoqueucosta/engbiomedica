---
titulo: >-
  Novocure Recebe Aprovação da FDA para Tratar Câncer de Pâncreas com Campos
  Elétricos [2026]
resumo: >-
  A FDA aprovou a terapia TTFields da Novocure para câncer de pâncreas
  localmente avançado, abrindo acesso a cerca de 15.000 pacientes
...
imagens:
  - src: >-
      /artigos/novocure-recebe-aprovacao-da-fda-para-tratar-cancer-de-pancr/ilustracao-tecnica-perspectivas-para-o-brasil-1.webp
    alt: 'Ilustração técnica: Perspectivas para o Brasil'
    caption: 'Ilustração: Perspectivas para o Brasil'
  - src: >-
      /artigos/novocure-recebe-aprovacao-da-fda-para-tratar-cancer-de-pancr/ilustracao-tecnica-impacto-no-mercado-de-medtech-2.webp
    alt: 'Ilustração técnica: Impacto no Mercado de MedTech'
    caption: 'Ilustração: Impacto no Mercado de MedTech'
tldr: >-
  A Novocure recebeu aprovação da FDA para tratar câncer de pâncreas localmente
  avançado com campos elétricos alternantes a chamada terapia por Campos
  Elétricos Tumorais (TTFields, do inglês Tumor Treating Fields), marcando uma
  nova indicação oncológica da empresa e abrindo acesso a cerca de 15.
---
...
<figure>
<img src="/artigos/novocure-recebe-aprovacao-da-fda-para-tratar-cancer-de-pancr/ilustracao-tecnica-impacto-no-mercado-de-medtech-2.webp" alt="Ilustração técnica: Impacto no Mercado de MedTech" width="1024" height="576" loading="eager" fetchpriority="high" decoding="async">
...
<figure>
<img src="/artigos/novocure-recebe-aprovacao-da-fda-para-tratar-cancer-de-pancr/ilustracao-tecnica-perspectivas-para-o-brasil-1.webp" alt="Ilustração técnica: Perspectivas para o Brasil" width="1024" height="576" loading="lazy" decoding="async">
