---
titulo: >-
  Como Registrar um Dispositivo Médico na ANVISA: Roteiro Prático para Startups
  e Fabricantes
resumo: >-
  Guia completo do processo de registro de dispositivos médicos na ANVISA:
  classificação, CBPF, ensaios técnicos, submissão no sistema SOLICITA e
  acompanhamento. Prazos reais, custos atualizados e erros mais comuns a evitar.
...
leitura: 14 min
imagens:
  - src: /artigos/como-registrar-dispositivo-medico-anvisa/fluxograma-com-dois-caminhos-de-registro-na-anvisa-noti-1.webp
    alt: >-
      Fluxograma com dois caminhos de registro na ANVISA: Notificação para
      dispositivos Classe I e II e Registro para Classe III e IV, com etapas,
      prazos e requisitos de CBPF para cada via regulatória.
    caption: >-
      Os dois caminhos regulatórios na ANVISA diferem drasticamente em prazo e
      custo. Identifique a classe do seu dispositivo antes de qualquer outra
      ação.
  - src: /artigos/como-registrar-dispositivo-medico-anvisa/especialista-em-assuntos-regulatorios-revisando-dossie--2.webp
    alt: >-
      Especialista em assuntos regulatórios revisando dossiê técnico de
      dispositivo médico com documentação IMDRF e sistema SOLICITA da ANVISA
      aberto no computador em escritório profissional.
    caption: >-
      A qualidade do dossiê técnico é o principal fator que determina o prazo de
      análise pela ANVISA. Documentação incompleta gera exigências que podem
      atrasar meses o processo.
  - src: /artigos/como-registrar-dispositivo-medico-anvisa/comparativo-de-custos-de-tfvs-da-anvisa-para-registro-d-3.webp
    alt: >-
      Comparativo de custos de TFVS da ANVISA para registro de dispositivos
      médicos por classe e porte de empresa, com descontos de até 95% para micro
      e pequenas empresas em 2026.
    caption: >-
      Os descontos de TFVS podem reduzir drasticamente o custo regulatório.
      Startups com receita abaixo de R$ 6 milhões já obtêm 60% de desconto
      automaticamente.
tldr: >-
  Registrar um dispositivo médico na ANVISA é um dos processos mais exigentes
  que uma startup ou fabricante pode enfrentar no mercado brasileiro.
---
...
<p>A notificação funciona como um ato declaratório: a empresa apresenta a documentação e, salvo irregularidades identificadas no prazo de análise, o produto fica automaticamente autorizado. O registro, por outro lado, envolve análise ativa pela ANVISA, que pode formular exigências técnicas durante o processo. Para compreender como a agência se organiza internamente para conduzir essas análises, veja nosso artigo sobre <a href="/artigos/como-funciona-a-anvisa-estrutura-atribuicoes-e-o-papel-na-re">a estrutura e as atribuições da ANVISA</a>.</p>

<blockquote><p>A ANVISA reconheceu oficialmente em 2025 um aumento significativo das filas de análise, atribuído à redução de 30% do quadro de servidores nos últimos 10 anos, ao aumento na complexidade tecnológica dos produtos e ao crescimento no volume de pedidos.</p><cite>— ANVISA, Edital de Chamamento 22/2025, 2025</cite></blockquote>
<figure>
<img src="/artigos/como-registrar-dispositivo-medico-anvisa/fluxograma-com-dois-caminhos-de-registro-na-anvisa-noti-1.webp" alt="Fluxograma com dois caminhos de registro na ANVISA: Notificação para dispositivos Classe I e II e Registro para Classe III e IV, com etapas, prazos e requisitos de CBPF para cada via regulatória." width="1024" height="571" loading="eager" fetchpriority="high" decoding="async" aria-details="desc-como-registrar-dispositivo-medico-anvisa-1">
<figcaption>Os dois caminhos regulatórios na ANVISA diferem drasticamente em prazo e custo. Identifique a classe do seu dispositivo antes de qualquer outra ação.
<details id="desc-como-registrar-dispositivo-medico-anvisa-1">
<summary>Descrição completa da imagem</summary>
<p>Fluxograma com dois caminhos de registro na ANVISA: Notificação para dispositivos Classe I e II e Registro para Classe III e IV, com etapas, prazos e requisitos de CBPF para cada via regulatória..</p>
</details>
</figcaption>
</figure>
...
<blockquote><p>Em 2019, 48,7% das certificações internacionais de Boas Práticas de Fabricação da ANVISA já se baseavam no MDSAP, demonstrando a consolidação do programa como via preferencial para fabricantes estrangeiros.</p><cite>— ANVISA/IMDRF, Relatório MDSAP, 2019</cite></blockquote>
...
<figure>
<img src="/artigos/como-registrar-dispositivo-medico-anvisa/especialista-em-assuntos-regulatorios-revisando-dossie--2.webp" alt="Especialista em assuntos regulatórios revisando dossiê técnico de dispositivo médico com documentação IMDRF e sistema SOLICITA da ANVISA aberto no computador em escritório profissional." width="1024" height="571" loading="lazy" decoding="async">
...
<blockquote><p>Em 2024, a ANVISA recebeu aproximadamente 380 pedidos via reliance regulatório (IN 290/2024) para dispositivos médicos, indicando adoção crescente dessa via acelerada por fabricantes com aprovações em mercados internacionais.</p><cite>— ANVISA, Balanço Regulatório de Dispositivos Médicos, 2024</cite></blockquote>
...
<figure>
<img src="/artigos/como-registrar-dispositivo-medico-anvisa/comparativo-de-custos-de-tfvs-da-anvisa-para-registro-d-3.webp" alt="Comparativo de custos de TFVS da ANVISA para registro de dispositivos médicos por classe e porte de empresa, com descontos de até 95% para micro e pequenas empresas em 2026." width="1024" height="571" loading="lazy" decoding="async">
