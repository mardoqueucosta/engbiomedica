...
imagens:
  - src: '/artigos/manutencao-equipamentos-hospitalares/image-1.webp'
    alt: 'Fluxograma de gestão de manutenção corretiva hospitalar com etapas de abertura de OS, diagnóstico, reparo e cálculo de MTTR'
    caption: 'Fluxo da manutenção corretiva hospitalar: da detecção da falha ao fechamento da OS com análise de causa raiz'
  - src: '/artigos/manutencao-equipamentos-hospitalares/image-2.webp'
    alt: 'Engenheiro clínico calibrando monitor multiparamétrico hospitalar com equipamento padrão INMETRO em ambiente de engenharia clínica'
    caption: 'Calibração rastreável de monitor multiparamétrico: processo que garante precisão diagnóstica e conformidade com a RBC/INMETRO'
  - src: '/artigos/manutencao-equipamentos-hospitalares/image-3.webp'
    alt: 'Infográfico da evolução da manutenção hospitalar de corretiva a preditiva com IoT e IA, mostrando redução de 70% no downtime não planejado'
    caption: 'Evolução das estratégias de manutenção hospitalar: da reatividade corretiva à preditividade com IoT e inteligência artificial'
---
