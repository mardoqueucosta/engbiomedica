...
<p>A principal inovação do QMSR é a <strong>harmonização com a ISO 13485:2016</strong>, norma internacional de sistemas de gestão da qualidade para dispositivos médicos. Ao incorporar os requisitos da ISO 13485 por referência, a FDA reduziu a duplicação de esforços para fabricantes que já possuem certificação para mercados internacionais, incluindo o europeu (MDR/IVDR) e o brasileiro (ANVISA). Estima-se que mais de <strong>6.500 estabelecimentos de fabricação</strong> registrados na FDA sejam diretamente afetados pela nova regulamentação.</p>
...
<ul>
  ...
  <li><strong>IEC 81001-5-1:2021</strong> — Segurança de software para a área da saúde</li>
