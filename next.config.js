...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/artigos/anvisa-dispositivos-medicos-guia', destination: '/artigos/anvisa-dispositivos-medicos-guia-2026', permanent: true },
      { source: '/artigos/assuntos-regulatorios-dispositivos-medicos', destination: '/artigos/anvisa-dispositivos-medicos-guia-2026', permanent: true },
      { source: '/artigos/anvisa-aprova-sistema-para-rastreamento-e-identificacao-de-d', destination: '/artigos/anvisa-aprova-sistema-de-rastreamento-e-identificacao-de-dis', permanent: true },
